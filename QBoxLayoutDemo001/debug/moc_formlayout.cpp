...
const QMetaObject FormLayout::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormLayout.data,
      qt_meta_data_FormLayout,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FormLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormLayout.stringdata0))
        return static_cast<void*>(const_cast< FormLayout*>(this));
