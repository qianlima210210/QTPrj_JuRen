...
QT_MOC_LITERAL(1, 10, 25), // "backBtnClickedInPlayScene"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "PlayScene\0backBtnClickedInPlayScene\0"
    ""
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backBtnClickedInPlayScene(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayScene::backBtnClickedInPlayScene)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayScene::backBtnClickedInPlayScene()
{
