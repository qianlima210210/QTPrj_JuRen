...
QT_MOC_LITERAL(1, 17, 32), // "backBtnClickedInChooseLevelScene"
QT_MOC_LITERAL(2, 50, 0) // ""

    },
    "ChooseLevelScene\0backBtnClickedInChooseLevelScene\0"
    ""
};
...
void ChooseLevelScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backBtnClickedInChooseLevelScene(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChooseLevelScene::backBtnClickedInChooseLevelScene)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChooseLevelScene::backBtnClickedInChooseLevelScene()
{
