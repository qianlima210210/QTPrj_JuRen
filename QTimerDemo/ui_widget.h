...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        stop->setGeometry(QRect(220, 20, 80, 15));
        goOn = new QPushButton(Widget);
        goOn->setObjectName(QStringLiteral("goOn"));
        goOn->setGeometry(QRect(220, 50, 80, 15));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        goOn->setText(QApplication::translate("Widget", "go on", Q_NULLPTR));
    } // retranslateUi
